...
export default function AdminSettingsClient({
 ...
 {/* Tabs */}
 <div className="flex border-b pg-border space-x-4">
 <button
 type="button"
 ...
 {activeTab === "general" && (
 <form autoComplete="off" onSubmit={handleAppSubmit} className="pg-surface shadow rounded-lg p-6 space-y-6 border pg-border glass-panel">
 <div className="border-b pg-border pb-4">
 <h3 className="text-lg font-semibold pg-text-heading mb-4">{t("landingContent")}</h3>
 <div className="space-y-4">
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("heroTitle")}</label>
 <input
 type="text"
 name="heroTitle"
 required
 ...
 className="w-full px-4 py-2 pg-bg-page border pg-border rounded-lg focus:ring-2 focus:ring-purple-500 outline-none pg-text-heading"
 />
 </div>

 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("heroSubtitle")}</label>
 <textarea
 name="heroSubtitle"
 rows={3}
 required
 ...
 <div>
 <h3 className="text-lg font-semibold pg-text-heading mb-4">{t("bankAccountTitle")}</h3>
 <div className="space-y-4">
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("bankName")}</label>
 <input
 type="text"
 name="bankName"
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("bankAccountNo")}</label>
 <input
 type="text"
 name="bankAccountNo"
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("bankAccountName")}</label>
 <input
 type="text"
 ...
 <div>
 <h3 className="text-lg font-semibold pg-text-heading mb-4">{st("csSettings")}</h3>
 <div className="space-y-4">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{st("csMode")}</label>
 <select
 name="csMode"
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{st("csOperatingHours")}</label>
 <input
 type="text"
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{st("csWhatsappNumber")}</label>
 <input
 type="text"
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{st("csEmail")}</label>
 <input
 type="email"
 name="csEmail"
 ...
 <div>
 <h3 className="text-lg font-semibold pg-text-heading mb-4">API & Keamanan (Rate Limit)</h3>
 <div className="space-y-4">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">Batas Request (Hits)</label>
 <input
 type="number"
 ...
 {activeTab === "prompt" && (
 <form autoComplete="off" onSubmit={handlePromptSubmit} className="pg-surface shadow rounded-lg p-6 space-y-6 border pg-border glass-panel">
 <div>
 <h3 className="text-lg font-semibold pg-text-heading mb-4">{t("promptSettingsTitle")}</h3>
 <div className="space-y-4">
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("videoSystemInstruction")}</label>
 <textarea
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("imageSystemInstruction")}</label>
 <textarea
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("defaultSpeechRate")}</label>
 <select
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("defaultNegativePrompt")}</label>
 <input
 type="text"
 ...
 <div>
 <label className="block text-sm font-medium pg-text-sub mb-1">{t("bannedWords")}</label>
 <textarea
 name="bannedWords"
 rows={3}
