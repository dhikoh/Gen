    ...
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Kelola pengguna dan sistem.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 shadow-sm rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        <div className="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800">
          <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">Pengguna Terbaru</h2>
        </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-zinc-500 dark:text-zinc-400 uppercase bg-zinc-50 dark:bg-zinc-800/50">
              <tr>
                ...
                <th className="px-6 py-3 font-medium">Status Langganan</th>
                <th className="px-6 py-3 font-medium">Daftar Sejak</th>
              </tr>
            </thead>
              ...
              {users.map((u) => (
                <tr key={u.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                  ...
                  <td className="px-6 py-4">
                    ...
                    <div className="text-xs text-zinc-500 mt-1">{u.currentPlan?.name || "Gratis"}</div>
                  </td>
