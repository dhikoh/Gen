...
export default async function LandingPage({ params }: { params: Promise<{ locale: string }> }) {
 ...
 <span className="font-extrabold text-xl tracking-tight pg-text-heading">Prompt Gen</span>
 </div>
 ...
 <h1 className="text-4xl md:text-6xl font-extrabold pg-text-heading tracking-tight max-w-4xl mx-auto leading-tight">
 {heroTitle}
 </h1>
 <p className="mt-6 text-lg md:text-xl pg-text-sub max-w-2xl mx-auto leading-relaxed">
 {heroSubtitle}
 </p>
 ...
 <a 
 href="#pricing"
 className="w-full sm:w-auto px-8 py-3.5 text-base font-medium pg-text-sub pg-surface border pg-border rounded-full hover:pg-surface-dim transition-all active:scale-95"
 >
 ...
 <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight pg-text-heading sm:text-4xl">
 {tLanding("featuresSubtitle")}
 </p>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
 {/* Feature 1 */}
 <div className="pg-surface-dim /50 p-8 rounded-2xl border pg-border/80 text-left">
 ...
 <h3 className="text-xl font-bold pg-text-heading mb-3">{tLanding("feature1Title")}</h3>
 <p className="pg-text-sub leading-relaxed text-sm">
 ...
 <h3 className="text-xl font-bold pg-text-heading mb-3">{tLanding("feature2Title")}</h3>
 <p className="pg-text-sub leading-relaxed text-sm">
 ...
 <h3 className="text-xl font-bold pg-text-heading mb-3">{tLanding("feature3Title")}</h3>
 <p className="pg-text-sub leading-relaxed text-sm">
 ...
 {/* Pricing Section */}
 <section id="pricing" className="py-24 pg-surface-dim ">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="text-center mb-16">
 ...
 {plans.map((plan) => (
 <div key={plan.id} className="bg-white rounded-3xl shadow-sm border pg-border overflow-hidden flex flex-col hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative group">
 {plan.code === "PRO" && (
 ...
 <span className="text-4xl font-extrabold pg-text-heading tracking-tight">
 Rp {plan.priceMonthly.toLocaleString('id-ID')}
 </span>
 <span className="pg-text-muted ml-1 font-medium">{tLanding("monthSuffix")}</span>
 </div>
 ...
 {(plan.features as Record<string, boolean> | null)?.imagePromptStudio && (
 <li className="flex items-start">
 <svg className="flex-shrink-0 h-5 w-5 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
 <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
 </svg>
 ...
 plan.code === "PRO"
 ? "pg-surface text-white hover:pg-surface-dim "
 ...
 <p className="pg-text-muted text-sm max-w-xl mx-auto mb-6">
 ...
 className="inline-flex items-center gap-2 pg-surface-dim hover:pg-surface pg-text-muted font-medium px-6 py-3 rounded-full pg-border border transition-all text-sm"
 >
 ...
 <p className="mt-4 text-xs pg-text-muted">
 ...
 {settings?.csWhatsappNumber && (
 <div className="text-xs pg-text-muted flex items-center gap-2">
 <span>CS WA:</span>
 <a
 ...
 <p className="pg-text-muted text-sm">
