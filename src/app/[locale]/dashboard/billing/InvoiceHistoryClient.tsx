...
export default function InvoiceHistoryClient({ 
 ...
 <div className="px-6 py-4 border-b pg-border pg-bg-page flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
 ...
 {loading ? (
 <div className="p-8 text-center text-sm pg-text-muted">
 ...
 <thead className="text-xs pg-text-muted uppercase pg-surface-dim/50 /30">
 <tr>
 ...
 <td colSpan={6} className="p-0 border-b pg-border">
 ...
 <div className="font-mono text-xs pg-text-sub">
 {inv.id.substring(0, 8).toUpperCase()}
 </div>
 <div className="font-medium pg-text-heading">
 {inv.plan.name}
 </div>
 <div>
 ...
 <div className="mt-2 p-3 pg-surface rounded border border-blue-200 dark:border-blue-800 font-mono text-xs">
 <p>{t('bank')} {bankName || "-"}</p>
