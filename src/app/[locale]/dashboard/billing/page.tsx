...
export default async function BillingPage({ params }: { params: Promise<{ locale: string }> }) {
 ...
 <h2 className="text-sm font-medium pg-text-muted mb-2">{t('currentPlan')}</h2>
 <div className="flex items-center space-x-4">
 <div className="text-2xl font-bold pg-text-heading">
 ...
 <p className="text-sm pg-text-muted mt-2">
