...
| **3.7 Invoicing & Billing** | Server-side pricing recalculation from DB, base64 transfer proof validation, idempotent approval. | `src/app/api/invoice/route.ts:50-95`<br>`src/lib/paymentProviders.ts:30-85` | **PASSED (100%)** |
